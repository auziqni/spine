...
void drawResultScreen()
{
    ...
    tft.setTextSize(3);
    tft.setTextColor(TFT_BLACK);
    String result = hasilBanding.message;
...
void processData()
{
    ...
    hasilBanding = compareValues(nilai_normalis, nilai_lordosis, nilai_kifosis, nilai_skoliosis);

    Serial.print(hasilBanding.index);
    Serial.println(hasilBanding.value);
    Serial.println(hasilBanding.message);
}
